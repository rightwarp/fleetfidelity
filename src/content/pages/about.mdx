...
meta:
  metaTitle: About
  metaDescription: >-
    Learn about FleetFidelity’s mission to bring clarity to fleet management.
    Discover how we help transportation companies streamline data, improve
    safety, reduce costs, and enhance driver retention.
  metaKeywords: >-
    FleetFidelity, About Us, Fleet Management, Data Insights, Transportation
    Technology, Safety Improvement, Compliance Solutions, Operational
    Efficiency, Driver Retention, Transportation Analytics
blocks:
  - heading: |
      # **About Us**
    _template: hero
