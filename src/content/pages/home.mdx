...
meta:
  metaTitle: Home
  metaDescription: >-
    FleetFidelity unites your fleet data into actionable insights to boost
    safety, profitability, and performance. Optimize your operations with
    real-time analysis and improved decision-making
  metaKeywords: >-
    Fleet Management, Fleet Performance, Data Insights, Driver Retention, Cost
    Reduction, Transportation Analytics, Fleet Optimization, Safety Dashboard,
    Operations Dashboard, Driver Scorecard, Risk Management
blocks:
  - isCollapsed: true
    heading: >
      **The Most Comprehensive Fleet-Driven
      ...
      FleetFidelity is the next evolution in fleet management, uniting all your
  ...
  - heading: >
      ...
      6/23](https://truckingresearch.org/about-atri/atri-research/operational-costs-of-trucking/)
    image:
